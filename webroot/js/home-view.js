/**
 * Created by rom on 5/19/17.
 */
var response;


function showResults(domain_id,study_id,scenario_id,levels,parent_id,data)
{
    locals=data.response.locals;
    getTerritorialLayer(domain_id,levels,parent_id);
...
//     getStudyTaxes(study_id,domain_data.types.length,id);
...
// function getStudyTaxes(study_id,levels,parent) {
//     $.ajax(
//         {
//             type: 'get',
...
function getStudyTaxes(domain_id, study_id, scenario_id, levels, parent, callback) {
    $.ajax(
        {
            type: 'get',
            url: '/Homes/getPoliticTaxes.json',
...
// function getTerritorialResults(domain_id,politic_id,scenario_id,taxes,levels,parent_id) {
//     $.ajax(
//         {
//             type: 'get',
...
function getTerritorialResults(domain_id, study_id, scenario_id, taxes, levels, parent_id, callback) {
    $.ajax(
        {
            type: 'get',
            ...
            success: function(data)
            {
                callback(domain_id,study_id,scenario_id,levels,parent_id,data);
