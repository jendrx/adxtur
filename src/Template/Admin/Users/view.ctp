                            ...
                            <table class="table">
                                ...
                                <?php foreach ($user['domains'] as $domain): ?>
                                    <tr>
                                        ...
                                        <td><?= $this->Form->postLink(__('Delete'), ['controller' => 'users_domains', 'action' => 'delete', $domain['_joinData']->id], ['confirm' => __('Are you sure you want to delete # {0}?', $domain['_joinData']->id)]) ?></td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
                            <?php  endif;?>
                            <?php echo $this->Html->link('Add Domain', ['controller' => 'users_domains', 'action' => 'add', $user->id], array('class' => 'button')) ?>
                        </div>
                    </div>
                </div>
            </div>
