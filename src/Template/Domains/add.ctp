		...
		<div class=" row well">
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div id="territories_board" class="panel-body" style="height:400px; max-height:450px; overflow:auto"
					     disabled="true">
                        <?php
                        echo $this->Form->control('territories._ids', ['options' => [], 'style' => 'height : 350px', 'label' => '']);
                        ?>
